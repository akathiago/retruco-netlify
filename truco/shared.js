...
// =====================================================
// CARD IMAGES — using assets/imagenes/cartastruco/ PNGs
// =====================================================
const CARD_IMAGES = {};
const _cardBasePath = (typeof CARD_BASE_PATH !== 'undefined') ? CARD_BASE_PATH : '../assets/imagenes/cartastruco/';
...
(function detectCards() {
    for (const s of SUITS) {
        for (const n of NUMBERS) {
            const key = `${n}-${s}`;
            // Format: ../assets/imagenes/cartastruco/Espada/1 de Espada.png
...
const OPPONENTS = {
    ...
    alfredito: {
        ...
        difficulty: 2,
        tier: 1,
        portrait: '../assets/imagenes/alfredito.png',
        color: '#2bb8cd',
    ...
    aliado: {
        ...
        difficulty: 2,
        tier: 2,
        portrait: '../assets/imagenes/aliado.png',
        placeholderPortrait: true,
        color: '#5DADE2',
    ...
    dario: {
        ...
        difficulty: 3,
        tier: 2,
        portrait: '../assets/imagenes/dario.png',
        color: '#AF7AC5',
    ...
    momo: {
        ...
        difficulty: 3,
        tier: 3,
        portrait: '../assets/imagenes/momo.png',
        placeholderPortrait: true,
        color: '#E74C3C',
    ...
    littleboogie: {
        ...
        difficulty: 3,
        tier: 3,
        portrait: '../assets/imagenes/littleboogie.png',
        placeholderPortrait: true,
        color: '#F39C12',
    ...
    wachin: {
        ...
        difficulty: 4,
        tier: 3,
        portrait: '../assets/imagenes/wachin.png',
        placeholderPortrait: true,
        color: '#1ABC9C',
    ...
    chino: {
        ...
        difficulty: 4,
        tier: 4,
        portrait: '../assets/imagenes/chino.png',
        placeholderPortrait: true,
        color: '#2ECC71',
    ...
    bignone: {
        ...
        difficulty: 5,
        tier: 5,
        portrait: '../assets/imagenes/bignone.png',
        color: '#E74C3C',
    ...
    xiao: {
        ...
        difficulty: 5,
        tier: 4,
        portrait: '../assets/imagenes/xiao.png',
        color: '#95A5A6',
